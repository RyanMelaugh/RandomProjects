...
public class TimeManager {
	...
	//New Idea for position 0: either 1 or 0, 1 represents a block of actions with more
	//than one different action. 0 Represents a block with all the same actions.
